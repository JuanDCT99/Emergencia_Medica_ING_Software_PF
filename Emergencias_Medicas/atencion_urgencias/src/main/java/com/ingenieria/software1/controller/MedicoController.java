...
public class MedicoController {
    ...
    public void initialize() {
        ...
        if (medicoLogueado != null) {
            lblBienvenida.setText("Bienvenido, " + medicoLogueado.getNombreCompleto() + " (" + medicoLogueado.getRol() + ")");
        }
        ...
        // El nivel de gravedad ahora viene del Triage
    ...
    private void refrescarTabla() {
        ...
        List<Urgencia> misUrgencias = emergenciaService.getTodasLasUrgencias().stream()
                .filter(u -> u.getPersonalAsignado() != null && 
                             u.getPersonalAsignado().getId().equals(medicoLogueado.getId()) &&
