...
public class RecepcionistaController {
    ...
    public void initialize() {
        ...
        // Mostrar nombre del paciente en la columna descripción (o crear una nueva)
        ...
        // El nivel de gravedad ahora vendrá del Triage (lo inicializamos en 0 si es PENDIENTE)
        ...
        cbFiltroEstado.setItems(FXCollections.observableArrayList("TODAS", "PENDIENTE", "EN_CURSO", "ATENDIDA"));
    ...
    public void onNuevaUrgenciaClick() throws IOException {
        ...
        // Verificar si la última urgencia agregada es nivel 5
        List<Urgencia> urgencias = emergenciaService.getTodasLasUrgencias();
        if (!urgencias.isEmpty()) {
            Urgencia ultima = urgencias.get(urgencias.size() - 1);
            if (ultima.getTriage() != null && ultima.getTriage().getNivelPrioridad() == 5) {
