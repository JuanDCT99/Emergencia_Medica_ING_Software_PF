...
public class App extends Application {
    ...
    private static Parent loadFXML(String fxml) throws IOException {
        ...
        // Inyectar CSS global
        try {
            var cssResource = App.class.getResource("/com/ingenieria/software1/view/styles.css");
            if (cssResource != null) {
                root.getStylesheets().add(cssResource.toExternalForm());
                System.out.println("CSS cargado: " + cssResource);
            } else {
                System.err.println("ERROR: No se encontró styles.css");
            }
        } catch (Exception e) {
